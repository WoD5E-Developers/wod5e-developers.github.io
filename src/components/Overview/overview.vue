    ...
    <div :class="$style['content']">
        ...
        <section>
            ...
            <div :class="$style['blurb']">
                ...
                Portions of the materials are the copyrights and trademarks of Paradox Interactive AB, and are used with permission. All rights reserved. For more information please visit <a href="https://worldofdarkness.com" target="_blank">worldofdarkness.com</a>.
            </div>
        </section>
    </div>
</template>

<style src="./overview.css" module></style>
